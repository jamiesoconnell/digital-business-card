...
export default function Info() {
    ...
    return (
        <div className="info">
            <img className="info--photo" src="./IMG_4681.jpg" alt="Jamie's photo"  />
            <h2 className="info--name">Jamie O'Connell</h2>
            <h4 className="info--position">Full Stack Software Engineer</h4>
            <p className="info--email">jamieoconnell6@gmail.com</p>
            <div className="info--button-container">
                <a href="https://www.gmail.com" target = "_blank" rel="noopener noreferrer" className="info--button">
                ...
                <a href="https://www.linkedin.com/in/jjamieoconnell/" target="_blank" rel="noopener noreferrer" className="info--button blue">
